...
function getSummonerSummary(id, output, client){
    ...
    var queryString = "SELECT format_name, base_name, profile_icon, total_kills, total_assists, total_turrets, wins FROM summary NATURAL JOIN summoner WHERE summoner_id = " + id;
