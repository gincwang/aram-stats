 ...
 *  @output: null
*/
function createSummoner(id, name){

    console.log('creating summoner: ' + id + ' ' + name);
    pg.connect(connectionString, function(err, client, done){
        if(err){
            ...
            var queryString = "INSERT INTO summoner (id, name) VALUES (" + id + ", '" + name + "')";
